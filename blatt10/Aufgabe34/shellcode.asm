...
int $0x80		# syscall to the function sys_socketcall(2,top of the stack)
			...
			# So we call bind(socketfd, pointer8bytesup~seebelow~, 16) and the pointer in the call points
			# To the stack where we find in this sequence: 0xd20402ff 0 0 (why did we give lenght 16 to this bind-function as paramter)?
